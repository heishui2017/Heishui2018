    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            min-height: 100vh;
            background-image: 
                radial-gradient(circle at 10% 20%, rgba(25, 25, 60, 0.7) 0%, rgba(10, 10, 18, 0.9) 90%),
                linear-gradient(to bottom, rgba(10, 10, 18, 0.95), rgba(20, 20, 40, 0.9));
    ...
    <script>
        ...
        DOM.themeToggle.addEventListener('click', function() {
            ...
            if (icon.classList.contains('fa-moon')) {
                ...
                document.body.style.setProperty('--bg-input', '#1a1a2e');
        ...
        function updateUI() {
            if (DB.currentUser) {
                ...
                if (DB.currentUser.isAdmin) {
                    DOM.officialCheckbox.style.display = 'flex';
                } else {
                    DOM.officialCheckbox.style.display = 'none';
                }
